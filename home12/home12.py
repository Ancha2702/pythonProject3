...
student = Student("Анна Ивановна Иванова")

# Добавление оценок и результатов тестов
student.add_score(4, 'Math')
student.add_score(5, 'Sport')
student.add_score(5, 'Biolog')

student.add_test_result(80, 'Math')
student.add_test_result(90, 'Sport')
student.add_test_result(20, 'Biolog')

print("Средний балл ученика", student.average_score_student())
print("Средний балл по тесту:", student.subject_test_average('Math'))